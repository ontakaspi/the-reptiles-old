...
class ProdukList1 extends Component{
    ...
    var header = new Headers();
        ...
        fetch(`https://be.thereptiles.muezabusiness.com/product/View/${decoded.id_user}`,{
            method:"GET",
            header:header,
        })
        .then(res=> res.json())
    ...
    UpdateData=()=>{
        ...
        axios.put('https://be.thereptiles.muezabusiness.com/product/editproduk/'+this.state.form.id_produk,newProduk,config).then(response=>{
            this.ModalInsert();
            this.ShowData();
    ...
    DeleteData=()=>{
        axios.delete('https://be.thereptiles.muezabusiness.com/product/'+this.state.form.id_produk).then(response=>{
            this.setState({
                ModalDelete: false
            })
            this.ShowData();
