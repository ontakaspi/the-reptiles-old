...
class OrderBelumTerkirim extends React.Component{
    constructor(){
     ...
     componentDidMount(){
        ...
        fetch(`https://be.thereptiles.muezabusiness.com/pesanan/penjual/${decoded.Username}/status/Belum dikirim`,{
            method:"GET",
            header:header,
        })
        .then(res=> res.json())
    ...
    UpdateStatus=()=>{
      ...
      axios.put('https://be.thereptiles.muezabusiness.com/pesanan/editpesanan/'+this.state.form.id_pesanan,PesananData).then(response=>{
          this.ModalEdit();
