...
class ProfilAdmin extends React.Component{
  ...
  Total=()=>{
      var header = new Headers();
        ...
        fetch('https://be.thereptiles.muezabusiness.com/Users/Total/',{
            method:"GET",
            header:header,
        }).then((res)=> res.json())
        .then(
  ...
  penjual=()=>{
    var header = new Headers ();
      header.append("Content-Type","application/json");
      fetch('https://be.thereptiles.muezabusiness.com/Users/Jumlah/Penjual',{
          method:"GET",
          header:header,
      }).then((res)=> res.json())
      .then(
  ...
  pembeli=()=>{
    var header = new Headers();
      header.append("Content-Type","application/json");
      fetch('https://be.thereptiles.muezabusiness.com/Users/Jumlah/Pembeli',{
          method:"GET",
          header:header,
      }).then((res)=> res.json())
      .then(
