...
class ProfilUser extends React.Component{
    ...
    showUser=()=>{
        ...
        fetch(`https://be.thereptiles.muezabusiness.com/Users/Penjual/User/${Username}`,{
            method: "GET",
            header:header,
        }).then(res=>res.json())
        .then(
    ...
    showProdukUser=()=>{
        ...
        var header = new Headers();
            ...
            console.log(Username)
        fetch(`https://be.thereptiles.muezabusiness.com/product/Username/${Username}`,{
            method:"GET",
            header: header,
        }).then(res=>res.json())
        .then(
    ...
    addtocart =()=>{
        ...
        axios.post('https://be.thereptiles.muezabusiness.com/keranjang/addtocart', newCart)
        .then(response =>{
          this.ModalSuccess();
    ...
    LaporkanBarang=()=>{
        const newProduk = new FormData();
            ...
            axios.put('https://be.thereptiles.muezabusiness.com/product/laporkan/'+this.state.form.id_produk,newProduk,config).then(response=>{
