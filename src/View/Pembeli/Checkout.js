    ...
    constructor(){
        ...
        componentDidMount =()=>{
            ...
            var header = new Headers();
                ...
                fetch(`https://be.thereptiles.muezabusiness.com/keranjang/view/${id_keranjang}`,{
                    method:"GET",
                    header:header,
                })
                .then(res=> res.json())
            ...
            deleteCart(){
                    axios.delete('https://be.thereptiles.muezabusiness.com/keranjang/delete/'+this.state.id_keranjang)
                    .then(response=>{
            ...
            AddOrder(){
                ...
                if( !document.getElementById('alamat').value || !document.getElementById('nomer').value ){
                    ...
                    axios.post('https://be.thereptiles.muezabusiness.com/pesanan/tambah_pesanan',newOrder)
                    .then(response=>{
                        this.ModalSuccess();
                        this.deleteCart();
