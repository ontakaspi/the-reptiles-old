...
showCart=()=>{
    ...
    var header = new Headers();
        ...
        fetch(`https://be.thereptiles.muezabusiness.com/keranjang/user/${decoded.id_user}/status/dalam keranjang`,{
            method:"GET",
            header:header,
        })
        .then(res=> res.json())
    ...
    deleteCart=()=>{
        axios.delete('https://be.thereptiles.muezabusiness.com/keranjang/delete/'+this.state.form.id_keranjang)
        .then(response=>{
            this.setState({
                ModalDelete: false
            })
